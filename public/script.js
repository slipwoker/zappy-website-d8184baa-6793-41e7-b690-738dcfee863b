    ...
    if (contactForm) {
      ...
      function validateField(input) {
        ...
        if (rules.minLength && value.length < rules.minLength) {
          showError(input, rules.message || 'Minimum ' + rules.minLength + ' characters required');
          return false;
        }

        if (rules.pattern && !rules.pattern.test(value)) {
          showError(input, rules.message || 'Invalid format');
          return false;
        }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'd8184baa-6793-41e7-b690-738dcfee863b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'd8184baa-6793-41e7-b690-738dcfee863b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd8184baa-6793-41e7-b690-738dcfee863b';
